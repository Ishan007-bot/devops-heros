...
![Networks created](image_task/networks-created.png)
...
![Backend on two networks](image_task/backend-multi-network.png)
...
![Network isolation](image_task/network-isolation.png)
...
![Apache host network](image_task/host-network.png)
...
```bash
mkdir bindmount
echo '<h1>Hello students</h1>' > bindmount/index.html
...
![Bind mount before](image_task/bindmount-before.png)
...
![Bind mount after](image_task/bindmount-after.png)
...
![Bind mount terminal](image_task/bindmount-terminal.png)
...
![Overlay network](image_task/overlay-network.png)
